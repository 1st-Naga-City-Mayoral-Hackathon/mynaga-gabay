...
import { Button } from './button'; // Assuming you have the Button component we set up earlier
import {
  User,
  CreditCard,
  Settings,
...
// 2. Complex Example with Sub-menus and Groups
