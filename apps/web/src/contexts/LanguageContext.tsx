...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'landing.hero.description':
      'Get health information, find nearby facilities, and understand your medications — all in Bikol, Filipino, or English.',
    ...
    'landing.trust.description':
      'Developed for the 1st Naga City Mayoral Hackathon to serve our Bikolano community with accessible health information in our native language.',
    ...
    'feature.facilities.desc':
      'Locate hospitals, clinics, and barangay health centers in Naga City with contact info and directions.',
    'feature.medications.title': 'Medication Info',
    'feature.medications.desc':
      'Learn about your medications, proper dosage, side effects, and drug interactions.',
    'feature.philhealth.title': 'PhilHealth Guide',
    'feature.philhealth.desc':
      'Check coverage, understand requirements, and learn how to avail your benefits.',
    'feature.voice.title': 'Voice-First',
    'feature.voice.desc':
      'Speak naturally in Bikol, Filipino, or English. Perfect for elderly and those who prefer speaking.',
    'feature.scanner.title': 'Prescription Scanner',
    'feature.scanner.desc':
      'Take a photo of your prescription to understand what each medication is for.',
    'feature.ai.title': 'AI-Powered',
    'feature.ai.desc':
      'Powered by advanced AI to give you accurate, helpful health information 24/7.',

    // Chat
    'chat.placeholder': 'Ask Gabay anything...',
    'chat.greeting': 'Hello! I am Gabay',
    'chat.description':
      'Your Bikolano health assistant. Ask me about health facilities, medications, PhilHealth coverage, or any health questions.',
    ...
    'voiceMode.instructions':
      'Speak naturally. Gabay will respond and continue listening. You can interrupt at any time.',
    ...
    'dashboard.announcement':
      'Free flu vaccination is now available at all Barangay Health Centers.',
    ...
    'philhealth.inpatient.desc':
      'Hospital confinement including room & board, medicines, labs, procedures, and professional fees. Coverage varies by case rate.',
    'philhealth.inpatient.limit': 'Case rate based',
    'philhealth.outpatient.title': 'Outpatient Care',
    'philhealth.outpatient.desc':
      'Consultation, laboratory tests, and minor procedures without hospital admission.',
    'philhealth.outpatient.limit': 'Per visit limit',
    'philhealth.maternity.title': 'Maternity Care',
    'philhealth.maternity.desc':
      'Prenatal to delivery care including normal delivery and cesarean section.',
    'philhealth.maternity.limit': 'NSD: ₱6,500 / CS: ₱19,000+',
    'philhealth.zbenefit.title': 'Z-Benefits',
    'philhealth.zbenefit.desc':
      'Catastrophic illnesses like cancer, kidney failure requiring dialysis, and other high-cost conditions.',
  ...
  fil: {
    ...
    'philhealth.page.subtitle':
      'Unawain ang iyong mga benepisyo sa PhilHealth at paano ito gamitin',

    // Coverage Types
    'philhealth.types.title': 'Mga Uri ng Saklaw',
    'philhealth.inpatient.title': 'Inpatient Care',
    'philhealth.inpatient.desc':
      'Pagka-ospital kasama ang kwarto, gamot, lab, at bayad sa doktor. Depende sa case rate.',
    ...
    'landing.hero.highlight': 'Bikol',
    'landing.hero.description':
      'Kumuha ng impormasyon sa kalusugan, maghanap ng mga kalapit na pasilidad, at unawain ang iyong mga gamot — lahat sa Bikol, Filipino, o English.',
    ...
    'landing.trust.description':
      'Binuo para sa 1st Naga City Mayoral Hackathon upang magbigay ng accessible na impormasyon sa kalusugan sa ating sariling wika.',
    ...
    'feature.facilities.desc':
      'Hanapin ang mga ospital, klinika, at barangay health center sa Naga City.',
    'feature.medications.title': 'Impormasyon ng Gamot',
    'feature.medications.desc':
      'Alamin ang tungkol sa iyong mga gamot, tamang dosage, side effects, at drug interactions.',
    'feature.philhealth.title': 'Gabay sa PhilHealth',
    'feature.philhealth.desc':
      'Tingnan ang coverage, unawain ang requirements, at alamin kung paano makuha ang iyong benefits.',
    'feature.voice.title': 'Voice-First',
    ...
    'chat.description':
      'Ang iyong Bikolano health assistant. Magtanong tungkol sa health facilities, gamot, PhilHealth coverage, o anumang tanong sa kalusugan.',
    'chat.newChat': 'Bagong Chat',
    'chat.recentChats': 'Kamakailang Chat',
    'chat.disclaimer':
      'Maaaring magkamali si Gabay. Siguraduhing i-verify ang mahalagang impormasyon.',
    ...
    'voiceMode.instructions':
      'Magsalita ng natural. Sasagutin ka ni Gabay at patuloy na makikinig. Pwede kang mag-interrupt anumang oras.',
    ...
    'dashboard.healthOffice': 'Naga City Health Office',
    'dashboard.announcement':
      'May libreng bakuna kontra-trangkaso sa lahat ng Barangay Health Centers.',
  ...
  bcl: {
    ...
    'philhealth.page.subtitle':
      'Intindihon an saimong benepisyo sa PhilHealth asin paano ini magagamit',

    // Coverage Types
    'philhealth.types.title': 'Mga Klase nin Sakop',
    'philhealth.inpatient.title': 'Inpatient Care',
    'philhealth.inpatient.desc':
      'Pagka-ospital kaibahan an kwarto, bulong, lab, asin bayad sa doktor. Depende sa case rate.',
    'philhealth.inpatient.limit': 'Base sa case rate',
    'philhealth.outpatient.title': 'Outpatient Care',
    ...
    'landing.hero.highlight': 'Bikol',
    'landing.hero.description':
      'Makakua nin impormasyon sa salud, maghanap nin mga harani na pasilidad, asin intindihon an saimong mga bulong — gabos sa Bikol, Filipino, o English.',
    ...
    'landing.trust.description':
      'Ginibo para sa 1st Naga City Mayoral Hackathon tanganing magtao nin accessible na impormasyon sa salud sa satong sadiring tataramon.',
    'landing.stats.facilities': 'Mga Pasilidad',
    ...
    'feature.facilities.desc':
      'Hanapon an mga ospital, klinika, asin barangay health center sa Naga City.',
    'feature.medications.title': 'Impormasyon nin Bulong',
    'feature.medications.desc':
      'Aramon an manungod sa saimong mga bulong, tamang dosage, side effects, asin drug interactions.',
    'feature.philhealth.title': 'Gabay sa PhilHealth',
    'feature.philhealth.desc':
      'Hilingon an coverage, intindihon an requirements, asin aramon kun paano makua an saimong benefits.',
    'feature.voice.title': 'Voice-First',
    'feature.voice.desc': 'Magtaram sa Bikol, Filipino, o English. Perpekto para sa mga gurang.',
    'feature.scanner.title': 'Prescription Scanner',
    'feature.scanner.desc':
      'Magkua nin litrato kan saimong reseta tanganing maintindihan an kada bulong.',
    'feature.ai.title': 'AI-Powered',
    ...
    'chat.greeting': 'Kumusta! Ako si Gabay',
    'chat.description':
      'An saimong Bikolano health assistant. Mag-hapot manungod sa health facilities, bulong, PhilHealth coverage, o arin man na hapot sa salud.',
    'chat.newChat': 'Bagong Chat',
    'chat.recentChats': 'Mga Nakaaging Chat',
    'chat.disclaimer':
      'Pwedeng magkasala si Gabay. Siguraduhon na i-verify an importante na impormasyon.',
    ...
    'voiceMode.instructions':
      'Magtaram nin natural. Masimbag ka ni Gabay asin padagos na madangog. Pwede kang mag-interrupt anuman na oras.',
    ...
    'dashboard.healthOffice': 'Naga City Health Office',
    'dashboard.announcement':
      'Igwang libreng bakuna kontra-trangkaso sa gabos na Barangay Health Centers.',
